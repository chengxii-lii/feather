...
- When every pinned tab is unloaded and nothing else is open, you land on a new tab.
- Normal tabs close as usual, and closing one never wakes up an unloaded pinned tab.
